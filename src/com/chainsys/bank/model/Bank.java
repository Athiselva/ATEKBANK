...
public class Bank {
	...
	public String toString() {
		return "Bank [username=" + username + ", password=" + password + ", flag=" + flag + ", id=" + id + ", cid="
				+ cid + ", name=" + name + ", fathersName=" + fathersName + ", email=" + email + ", phonenumber="
				+ phonenumber + ", gender=" + gender + ", balance=" + balance + ", amount=" + amount
				+ ", accountnumber=" + accountnumber + ", dob=" + dob + ", p_Address=" + p_Address + ", p_City="
				+ p_City + ", c_Address=" + c_Address + ", c_City=" + c_City + ", state=" + state + ", ifsc=" + ifsc
				+ ", createdDate=" + createdDate + ", ModifiedDate=" + ModifiedDate + ", mmid=" + mmid
				+ ", transactionID=" + transactionID + ", cbal=" + cbal + ", amt=" + amt + ", tdate=" + tdate
				+ ", acnumber=" + acnumber + ", mmid2=" + mmid2 + ", getMmid2()=" + getMmid2() + ", getAcnumber()="
				+ getAcnumber() + ", getAmount()=" + getAmount() + ", getCid()=" + getCid() + ", getTdate()="
				+ getTdate() + ", getAmt()=" + getAmt() + ", getCbal()=" + getCbal() + ", getTransactionID()="
				+ getTransactionID() + ", getId()=" + getId() + ", getAccountnumber()=" + getAccountnumber()
				+ ", getPhonenumber()=" + getPhonenumber() + ", getMmid()=" + getMmid() + ", getUsername()="
				+ getUsername() + ", getPassword()=" + getPassword() + ", isFlag()=" + isFlag() + ", getName()="
				+ getName() + ", getFathersName()=" + getFathersName() + ", getEmail()=" + getEmail() + ", getGender()="
				+ getGender() + ", getBalance()=" + getBalance() + ", getDob()=" + getDob() + ", getP_Address()="
				+ getP_Address() + ", getP_City()=" + getP_City() + ", getC_Address()=" + getC_Address()
				+ ", getC_City()=" + getC_City() + ", getState()=" + getState() + ", getIfsc()=" + getIfsc()
	...
	public int hashCode() {
		...
		result = prime * result + ((mmid2 == null) ? 0 : mmid2.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (mmid2 == null) {
			if (other.mmid2 != null)
				return false;
		} else if (!mmid2.equals(other.mmid2))
			return false;
		if (name == null) {
			if (other.name != null)
				return false;
