...
public class Payee {
	...
	private Long neftcount;
	private Long impscount;

	
	public Long getImpscount() {
		return impscount;
	}

	public void setImpscount(Long impscount) {
	...
	public Long getNeftcount() {
		return neftcount;
	}

	public void setNeftcount(Long neftcount) {
		this.neftcount = neftcount;
	}
	...
	public String toString() {
		return "Payee [payee_name=" + payee_name + ", payee_mmid=" + payee_mmid + ", payee_balance=" + payee_balance
				...
				+ payee_accountnumber + ", count=" + count + ", id=" + id + ", balance=" + balance + ", amount="
				+ amount + ", totalcount=" + totalcount + ", neftcount=" + neftcount + ", impscount=" + impscount
				+ ", getImpscount()=" + getImpscount() + ", getTotalcount()=" + getTotalcount() + ", getNeftcount()="
				+ getNeftcount() + ", getAmount()=" + getAmount() + ", getBalance()=" + getBalance() + ", getId()="
				+ getId() + ", getCount()=" + getCount() + ", getAccountnumber()=" + getAccountnumber()
	...
	public int hashCode() {
		...
		result = prime * result + ((impscount == null) ? 0 : impscount.hashCode());
		result = prime * result + ((neftcount == null) ? 0 : neftcount.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id == null) {
			...
			return false;
		if (impscount == null) {
			if (other.impscount != null)
				return false;
		} else if (!impscount.equals(other.impscount))
			return false;
		if (neftcount == null) {
			if (other.neftcount != null)
				return false;
		} else if (!neftcount.equals(other.neftcount))
			return false;
